...
\begin{definition}
	A subset~$D$ of a topological space~$X$ is \defemph{dense} if it intersects every nonempty open subset of~$X$ non-trivially. That is, for every nonempty open subset~$U$ of~$X$, the intersection~$D ∩ U$ is again non-empty.
\end{definition}
